...
public class Login extends JPanel {
	...
	public Login() {
		...
		lblUsuario.setBounds(98, 261, 70, 20);
		add(lblUsuario);
		
		textField = new JTextField();
		textField.setBounds(178, 261, 216, 20);
		add(textField);
		textField.setColumns(10);
		
		JLabel lblPassword = new JLabel("Password");
		lblPassword.setHorizontalAlignment(SwingConstants.CENTER);
		lblPassword.setBounds(108, 292, 53, 14);
		add(lblPassword);
		...
		passwordField.setBounds(178, 292, 216, 14);
		add(passwordField);
		
		JButton btnNewButton = new JButton("Iniciar Sesi\u00F3n");
		btnNewButton.setBounds(178, 327, 114, 42);
		add(btnNewButton);
