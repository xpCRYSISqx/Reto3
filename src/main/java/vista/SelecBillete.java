...
public class SelecBillete extends JPanel {
	...
	public SelecBillete() {
		...
		btnInicioDeSesin.setBounds(435, 11, 107, 23);
		add(btnInicioDeSesin);
		
		JButton btnNewButton = new JButton("Registrar");
		btnNewButton.setBounds(435, 45, 107, 23);
		add(btnNewButton);
		
		JButton btnContinuar = new JButton("Continuar");
		btnContinuar.setBounds(435, 510, 107, 23);
		add(btnContinuar);
		
		JLabel lblNewLabel = new JLabel("SELECCI\u00D3N DE BILLETE");
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setFont(new Font("Mistral", Font.PLAIN, 44));
		lblNewLabel.setBounds(10, 15, 361, 53);
		add(lblNewLabel);
		
		JButton btnCancelar = new JButton("Cancelar");
		btnCancelar.setBounds(10, 510, 89, 23);
		add(btnCancelar);
		
		JCheckBox chckbxSimple = new JCheckBox("Simple");
		chckbxSimple.setBounds(150, 154, 97, 23);
		add(chckbxSimple);
		
		JCheckBox chckbxIdaVuelta = new JCheckBox("Ida / Vuelta");
		chckbxIdaVuelta.setBounds(266, 154, 97, 23);
		add(chckbxIdaVuelta);
