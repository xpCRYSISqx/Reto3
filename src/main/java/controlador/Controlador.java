...
public class Controlador {
	...
	public void manejoInterfaz() {
		...
		botones.BotonIrRegistro(vista.sel_fecha.btnRegistro, vista.sel_fecha, vista.registro);
		...
		botones.IrInicioSesionARegistro(vista.login.btnRegistro, vista.login, vista.registro);
